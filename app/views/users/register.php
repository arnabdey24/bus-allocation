                        ...
                        <div class="container">
                            <div class="card2 card border-0 px-4 py-6">
                                ...
                                <div class="row px-3 form-group">
                                    ...
                                    <input type="email" name="edu_email" placeholder="Enter your edu email" class="form-control mb-3 <?php echo (!empty($data['edu_email_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['edu_email']; ?>">
